...
public class Level4  extends JPanel implements ActionListener {
    ...
    private JLabel info = new JLabel("LEVEL 4");
    ...
    private JButton next = new JButton("See Scores");
    private CardLayout layout;
    private JPanel main;
    
    public Level4(CardLayout layout, JPanel main, Level1 l1, Level2 l2, Level3 l3){
        this.l1 = l1;
        this.l2 = l2;
        this.l3 = l3;
        this.layout = layout;
       ...
       this.add(hint3);
        ...
        w1 = new Word("FLOWER", "WOREFL");
        w2 = new Word("CANDLE", "LEDNAC");
        w3 = new Word("ISLAND", "NDASLI");
    ...
    w3.hintTimer.start();
           ...
           levelComplete = true;
           this.layout.show(this.main, "Results");
            Results r = new Results(layout, main, l1, l2, l3, this);
            main.add(r, "Results");
            layout.show(main, "Results");
       }
