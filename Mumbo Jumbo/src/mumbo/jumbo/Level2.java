...
public class Level2 extends JPanel implements ActionListener {
    ...
    private JLabel info = new JLabel("LEVEL 2");
    ...
    public Level2(CardLayout layout, JPanel main){
        this.layout = layout;
        this.main = main;
       ...
       this.add(hint3);
        ...
        w1 = new Word("CRAB", "BARC");
        w2 = new Word("MILK", "KLIM");
        w3 = new Word("BIRD", "DRIB");
        w1.setBounds(90,50,450,100);
        w2.setBounds(90,150,450,100);
        w3.setBounds(90,250,450,100);
