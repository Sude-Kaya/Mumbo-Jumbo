...
public class Level1 extends JPanel implements ActionListener {
    ...
    private JLabel info = new JLabel("Put the letters in the correct order to make words!");
    ...
    private JPanel main;
    public Level1(CardLayout layout, JPanel main){
       ...
       this.add(hint3);
        ...
        w2 = new Word("SUN", "NUS");
        w3 = new Word("CAR", "RAC");
        w1.setBounds(120,50,450,100);
        w2.setBounds(120,150,450,100);
        w3.setBounds(120,250,450,100);
